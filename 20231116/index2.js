...
Promise.all([1, 2, Promise.reject(10), Promise.reject(20)]).then(res => {
  console.log(res);
}, res => {
  console.log(res)
}).catch(res => {
...
Promise.race([Promise.reject(10), 1, 2, Promise.reject(20)]).then(res => {
  console.log(res);
}, res => {
  console.log(res)
}).catch(res => {
...
Promise.any([ Promise.reject(10), 1, 2,Promise.reject(20)]).then(res => {
  console.log(res);
}, res => {
  console.log(res)
}).catch(res => {
...
Promise.allSettled([1, 2, Promise.reject(10), Promise.reject(20)]).then(res => {
  console.log(res);
}, res => {
  console.log(res)
}).catch(res => {
